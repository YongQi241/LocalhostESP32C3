...
extern uint16_t lastDistanceMM;      // last distance reading, used for delta comparisons
extern int      lastLightRaw;        // last light reading, used for delta comparisons
extern bool     hasBaseline;         // false until the first reading has been taken
extern uint16_t distanceThresholdMM; // live-configurable "sudden" swing for distance
extern int      lightThreshold;      // live-configurable "sudden" swing for light
