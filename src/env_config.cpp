...
const String MQTT_TOPIC_DATA =
    String("xiao/esp32c3/sensors/") + MQTT_DEVICE_ID + "/data";
const String MQTT_TOPIC_THRESHOLD =
    String("xiao/esp32c3/sensors/") + MQTT_DEVICE_ID + "/threshold";
